...
class Tirp {
	constructor(symbols, relations, size, vs0, mhs0, mmd0, vs1, mhs1, mmd1, rating) {
...
class SearchGraph extends Component {
	measureToTitles = {
		vs0: 'Vertical Support Class 0',
		mhs0: 'Mean Horizontal Support Class 0',
		mmd0: 'Mean Mean Duration Class 0',
		vs1: 'Vertical Support Class 1',
		mhs1: 'Mean Horizontal Support Class 1',
		mmd1: 'Mean Mean Duration Class 1',
	...
	calculateTirps() {
		const tirps = this.props.tirps.map((result) => {
			...
			return new Tirp(symbols, relations, size, vs0, mhs0, mmd0, vs1, mhs1, mmd1, rating);
		});
									...
									tooltip: {
										...
										callbacks: {
											title: (items) => {
												...
												const symbols = tirp.symbols.slice(
													1,
													tirp.symbols.length - 1
												);
