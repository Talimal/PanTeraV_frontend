...
class TIRPsPie extends Component {
	...
	drawPie = () => {
		// let pie_title0 = 'Class 0 - ' + localStorage.class_name;
		let pie_title0 = 'Dataset distribution'
		if (this.props.type_of_comp === 'tirp') {
			return this.renderTirpPie(this.state.pie0_propAsArray, pie_title0, '100%', false);
		} else {
			let pie_title1 = 'Class 1 - ' + localStorage.second_class_name;
