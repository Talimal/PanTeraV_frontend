...
const ExploreSymbol = (props) => {
    ...
    useEffect( () => {
        setCenterSymbol(props.focusSymbol);
        setCenterSymbolRelations(tirp.getVectorInSize(tirp.getIndexOfSymbol(centerSymbol)));
        ...
        setNextSymbolRelations(tirp.getVectorInSize(tirp.getIndexOfSymbol(centerSymbol)+1));
        setPrefixSymbolRelations(tirp.getVectorInSize(tirp.getIndexOfSymbol(centerSymbol)-1));
        prefixTirps.current = props.getPrevVectorTirps(centerSymbol,centerSymbolRelations);
        nextTirps.current = props.getNextVectorTirps(centerSymbol,centerSymbolRelations);
    ...
    return (
        ...
        <div className="exploreScreen">
            {/* <div className="TIRP">
                <h3
                 {...console.log(tirp)}
                >Tirp: {tirp.getSymbolsNames()} Relations:{tirp.printRelations()}</h3>
            </div> */}
            <div className="symbols">
                ...
                <div className="beforeSymbols">
                    ...
                    <SymbolRelationList
                        ...
                        symbolsToNames={props.symbolsToNames}
                    />
                ...
                <div className="centerSymbol">
                    <CenterSymbol
                        symbol={centerSymbol}
                        symbolName={tirp.getSymbolNameBySymbol(centerSymbol)}
